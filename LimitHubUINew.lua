...
local function Maximise(Window)
	Window.Controls.ToggleSize.ImageLabel.Image = "rbxassetid://124982984632192"
...
function Luna:CreateWindow(WindowSettings)
	...
	LoadingFrame.Version.Text = LoadingFrame.Frame.Frame.Title.Text == "LimitHub" and Release or "LimitHub UI"
