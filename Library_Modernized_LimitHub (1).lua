...
-- Modernized LimitHub UI Button
local LimitHubOuter = Library:Create('Frame', {
    BorderColor3 = Color3.new(0, 0, 0);
...
local LimitHubInner = Library:Create('Frame', {
    BackgroundColor3 = Library.MainColor;
    BorderColor3 = Library.AccentColor;
    BorderMode = Enum.BorderMode.Inset;
    Size = UDim2.new(1, 0, 1, 0);
    ZIndex = 201;
    Parent = LimitHubOuter;
});
Library:AddToRegistry(LimitHubInner, { BorderColor3 = 'AccentColor'; });

local LimitHubInnerFrame = Library:Create('Frame', {
    BackgroundColor3 = Color3.new(1, 1, 1);
    BorderSizePixel = 0;
    Position = UDim2.new(0, 1, 0, 1);
    Size = UDim2.new(1, -2, 1, -2);
    ZIndex = 202;
    Parent = LimitHubInner;
});

local LimitHubGradient = Library:Create('UIGradient', {
    Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Library:GetDarkerColor(Library.MainColor)),
        ColorSequenceKeypoint.new(1, Library.MainColor),
    });
    Rotation = -90;
    Parent = LimitHubInnerFrame;
});
Library:AddToRegistry(LimitHubGradient, {
    Color = function()
        return ColorSequence.new({
            ColorSequenceKeypoint.new(0, Library:GetDarkerColor(Library.MainColor)),
            ColorSequenceKeypoint.new(1, Library.MainColor),
...
local LimitHubButton = Library:Create('TextButton', {
    Position = UDim2.new(0, 5, 0, 0);
...
LimitHubButton.MouseButton1Down:Connect(function()
